async function submitReimbursement(event) {
  ...
  try {
    let res = await fetch("http://localhost:8080/p1colin/employee/submit", {
      method: "POST",
...
async function getAllTickets(event) {
  ...
  try {
    let res = await fetch(
      "http://localhost:8080/p1colin/employee/reimbursements",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function authenticateUser() {
  try {
    let res = await fetch("http://localhost:8080/p1colin/login/employee", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
